...
## Project Structure
    ...
    ├── basketball_toons_35105  # Django project configurations
...
1. Clone this repo and `cd basketball_toons_35105`
...
2. Clone this repo and `cd basketball_toons_35105`
